...
// void plot(vector<vector<double>> data, string title, string x_label, string
// y_label) {
// //     ImPlot::SetNextPlotLimits(0, 1, 0, 1, ImGuiCond_Always);
// //     if (ImPlot::BeginPlot(title.c_str(), x_label.c_str(),
// y_label.c_str())) {
...
// }
void plot(
    vector<vector<double>> data, string title, string x_label, string y_label
) {
...
// void plot(std::vector<double> times, int id, std::string vname, std::string
// fname){
//     std::vector<std::string> colors = {"Green","Purple", "IndianRed", "Aqua",
//     "Aquamarine", "Azure", "Beige", "Bisque", "Black", "BlanchedAlmond",
//     "Blue"}; std::vector<std::vector<double>> data =
//     readCSV_to_MultidimensionalArray(fname, false); std::vector<double> col;
//     for (auto& row: data){
...
//     {"color",colors[(id-1)%colors.size()]}, {"linewidth", "2"}});
//     plt::legend();
